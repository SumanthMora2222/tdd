...
public class OrderListenerTest {
    ...
    @Test
    public void shouldNotPassOrderToServiceWhenOrderIsInFutureTime() {
        OrderService orderService = Mockito.mock(OrderService.class);
        OrderListener orderListener = new OrderListener(orderService);
        ...
        Mockito.verify(orderService, never()).publish(any());
    }

    @Test
    public void shouldIgnoreFutureOrdersAndPublishOtherOrders() {
        OrderService orderService = Mockito.mock(OrderService.class);
        OrderListener orderListener = new OrderListener(orderService);
        ...
        Mockito.verify(orderService).publish(Arrays.asList(order2));
    }
